#!/usr/bin/python3
"""
Module defining geometric shapes Rectangle and Square with area computation.
"""
...
class Square(Rectangle):
    ...
    def __str__(self):
        """Return string representation of the square using
        parent class name."""
        return "[{}] {}/{}".format(self.__class__.__base__.__name__,
